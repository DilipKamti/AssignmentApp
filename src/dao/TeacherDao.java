...
public class TeacherDao {
	...
	public String teacherregister(TeacherPojo pojo) 
	{
		String sql="insert into teacher_details (t_id ,name ,username ,password ,email ,faculty,contact) values (?,?,?,?,?,?,?)";
	    ...
	    String s="Teacher";
	  	 try
		  {
				...
				stmt.setString(6, pojo.getFaculty());
				stmt.setString(7, pojo.getContact());
