            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Submission List</h4>
                                <div class="table-responsive">
                                 <table class="table table-striped table-bordered zero-configuration">
                                    <%@page import="Controller.view"%>
                                    <%@page import="java.util.ArrayList"%>
                                    <%@page import="model.viewBean"%>
                                    
                                     <% ArrayList<viewBean> list=(ArrayList<viewBean>) session.getAttribute("submissionList");%>
                                        ...
                                        <tbody>
                                          <% for(int i=0; i<list.size(); i++){ %>   
                                            ...
                                            <tr>    
                                                ...
                                                <td><%=list.get(i).getAssignmentDetails()%></td>
                                                <td><%=list.get(i).getSubmissionDate()%></td>  
                                            </tr>
      <%} %>     
      </tbody>     
                                    </table>
