                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                 <table class="table table-striped table-bordered zero-configuration">
                                    ...
                                    <%@page import="model.TAssignmentBean"%>
                                    
                                     <% ArrayList<TAssignmentBean> list=(ArrayList<TAssignmentBean>) session.getAttribute("teacherList");%>
                                        ...
                                        <tbody>
                                          <% for(int i=0; i<list.size(); i++){ %>   
                                            ...
                                            <tr>    
                                                ...
                                                <td>
							                          <button> <a href="view?AssignmentId=<%=list.get(i).getAid()%>"/>View</a> </button>
                                                </td>
                                            </tr>
      <%} %>     
      </tbody>     
