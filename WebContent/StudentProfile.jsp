            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-9">
                        ...
                        <div class="card">
                            <div class="card-body">
								...
								<%
									...
									stmt=con.prepareStatement("select * from student_details where username=?");
									stmt.setString(1, s);
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="card card-profile text-center">
                                            ...
                                            <p class="text-muted"><%=rs.getString(7)%></p>
                                        </div>
                                        </div>
                                        <div class="col">
                                        <div class="card card-profile text-center">
                                           
                                            <h3 class="mb-0">Roll No.</h3>
                                            <p class="text-muted"><%= rs.getString(8) %></p>
                                        </div>
                                        </div>
                                    </div>
                        ...
                        <h4>About Student</h4>
                                <p class="text-muted"><%=rs.getString(2) %> is the student from <%=rs.getString(6) %> depertment of SVIST </p>
								<%
								}
								%>
