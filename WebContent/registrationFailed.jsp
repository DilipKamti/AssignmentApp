...
<title>Registartion Falied</title>
 <!-- Favicon icon -->
                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center">
                                <h1 class="error-text text-primary">Registartion Falied</h1>
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> Bad Request</h4>
                                <p>Your Request resulted in an error.</p>
                                <form class="mt-5 mb-5">
                                    
                                    <div class="text-center mb-4 mt-4"><a href="login.jsp" class="btn btn-primary">Go to LoginPage</a>
                                    </div>
                                </form>
